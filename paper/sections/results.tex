...
The specialist is deployed for $k{\ge}20$, where it reclaims the slack regime,
exceeding both Cal-DP ($448.0$) and Greedy+Budget ($448.7$) at $k{=}40$;
the unified model handles $k{\le}19$, and Cal-DP retains the strongest position
in the transitional band ($k \in [8, 20]$).
